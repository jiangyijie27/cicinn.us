    ...
    <>
      ...
      <div className="block-y">
        ...
        <div className="footer">
          <div>
            <span className="footer-link">cicinn.us</span> is a tiny page made
            for celebrating the birthday of{" "}
            <span className="footer-aragakey">Cicinnus Cheng</span> who's an
          ...
          <div>
            ...
            paid ¥53.95 for this domain name. It'll expire on January 31, 2024.
            If you need to renew it, you can contact me then.
          </div>
          <div>
            <span className="footer-link">cicinn.us</span> may load relatively
            slowly, cuz it's hosted on github which is free. If you want it to
            be faster, you'll have to figure it out yourself (or pay me).
          </div>
          <div>
          ...
          <div>
            ...
            <span className="footer-aragakey">Cicinnus</span>. Hope you like it
            (if you don't, I'll never talk to you for the rest of my life).
          </div>
